...
export default function Note(props) {
  ...
  return (
    <div className='note' style={{backgroundColor: props.note.color}} >
      <textarea className='note_text' defaultValue={props.note.text} onChange={(e) => handleText(e.target.value, props.note.id)} placeholder='Write here...' />
